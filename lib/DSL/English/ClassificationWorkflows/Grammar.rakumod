...
grammar DSL::English::ClassificationWorkflows::Grammar
    ...
    rule ensemble-by-single-method-command { [ <ensemble-creation-num> | <ensemble-creation-simple> ] [ [ <.using-preposition> | <.and-conjunction> ] <resampling-spec> ]? }
    ...
    rule ensemble-creation-simple {
        <.classifier-creation-opening> [ <classifier-method-spec>? <.classifier-ensemble-phrase> ] |
        <.classifier-ensemble-phrase> <.using-preposition> <classifier-method-spec> }
    rule ensemble-creation-num {
        <.classifier-creation-opening> <.classifier-ensemble-phrase> [ <.using-preposition> | <.of-preposition> | <.with-preposition> ] <number-of-classifiers> <.of-preposition>? <classifier-method-spec> <.classifier-method-phrase>? }
